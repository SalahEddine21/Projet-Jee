	      ...
	      <div class="row" >
	      	<div class="col-lg-4">
				<div class="list-group">
					 ...
					 <a href="gestion_modules" class="list-group-item active">Gestion des modules</a>
	      	...
	      	<div class="col-lg-8">
				<div class="row">
				    <div class="col-lg-12">
				      	<h4 style="margin-top:10px;" >Ajouter Un module</h4>
				      	<hr>
				      	<p>${requestScope.query}</p>
				    </div>		
				</div>
				<form action="gestion_modules" method="post">
					 <div class="col-lg-10">
						<div class="form-group">
							<input type="text" name="titre" class="form-control" placeholder="titre" />
							<p style="color:red;">${controle.errors.titre}</p>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label for="sel1">Selectionner Le professeur enseignant</label>
							<select class="form-control" name="id_prof">
								<c:forEach items="${requestScope.professeurs}" var="prof" >
					...
					<table class="table table-bordered table-sm">
						...
						<c:forEach items="${requestScope.modules}" var="module">
							<tr>
								...
								<td>${module.nom_prof}</td>
								<td><a href="suppMod?id_mod=${module.id}" class="btn btn-indigo btn-sm" >Supprimer</a></td>
							</tr>
						</c:forEach>
						</tbody>
					</table>
					<p><strong style="color:red;">Notice:</strong>La suppression d'un module entrainra la suppression de tous ses dépendances</p>						
					</div>
				</div>					      		
	      	</div>
	      </div>
