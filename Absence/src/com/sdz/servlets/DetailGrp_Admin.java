...
public class DetailGrp_Admin extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
		...
		try {
			...
			if(seances.isEmpty()) request.setAttribute("no_seance", "Aucune donnée n'est disponible ");
			else request.setAttribute("seances", seances);
		...
		this.getServletContext().getRequestDispatcher("/Admin/DetailGrp.jsp").forward(request, response);
	}
